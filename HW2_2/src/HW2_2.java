...
class Blend implements IMixture {
  ...
  public Color getFinalColor() {
    return new Color(
        (int)Math.round((this.paint1.getFinalColor().getRed() +
            this.paint2.getFinalColor().getRed()) / 2.0),
        (int)Math.round((this.paint1.getFinalColor().getGreen() +
            this.paint2.getFinalColor().getGreen()) / 2.0),
        (int)Math.round((this.paint1.getFinalColor().getBlue() +
            this.paint2.getFinalColor().getBlue()) / 2.0));
  }
...
class ExamplesPaint {
  ...
  boolean testGetFinalColor(Tester t) {
    return t.checkExpect(this.red.getFinalColor(), new Color(255, 0, 0)) &&
        ...
        t.checkExpect(this.mauve.getFinalColor(),
            new Color((255 / 2), (255 / 2 / 2), (255 / 2) / 2))
        &&
        t.checkExpect(this.pink.getFinalColor(),
            new Color((255 / 2), (255 / 2 / 2), (255 / 2) / 2));
