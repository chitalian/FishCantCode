...
class ExamplesXML {
  ...
  boolean testSameAtt(Tester t) {
    return t.checkExpect((new Att("hello", "world"))
        .sameAttribute(new Att("hello", "world")), true) &&
        t.checkExpect((new Att("hello", "dog"))
            .sameAttribute(new Att("hello", "world")), false);
  }
  ...
  boolean testSameXMLFrag(Tester t) {
    ...
    return t.checkExpect((new Plaintext("I am XML!"))
        .sameXMLFrag(new Plaintext("I am XML!")), true) &&
